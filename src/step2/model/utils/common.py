...
def get_scheduler(cfg, optimizer):
    if cfg.type == 'plateau':
        ...
        print(f"Initializing CosineAnnealingLR with T_max={cfg.T_max} and eta_min={cfg.eta_min}")
        return torch.optim.lr_scheduler.CosineAnnealingLR(
            optimizer,
            T_max=cfg.T_max,        # Total training iterations
            eta_min=cfg.eta_min     # Minimum learning rate
        )
